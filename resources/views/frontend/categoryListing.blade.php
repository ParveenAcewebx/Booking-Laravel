...
@section('content')
  ...
  <div class="relative h-64 bg-cover bg-center flex items-center justify-center text-center text-white"
       style="background-image: url('https://source.unsplash.com/1600x400/?category,abstract');">
    <div class="bg-black/50 w-full h-full absolute top-0 left-0 z-0"></div>
    <h1 class="z-10 text-4xl md:text-5xl font-bold">Categories</h1>
  </div>

  <!-- Categories Grid -->
  <div class="max-w-7xl mx-auto px-4 py-12">
    <h2 class="text-3xl font-bold mb-8 text-gray-900 dark:text-white">All Categories</h2>
