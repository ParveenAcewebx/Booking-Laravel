    ...
    <div class="w-3/4 bg-white shadow rounded-2xl p-6">
        ...
        @if(Request::routeIs('vendor.bookings.view'))
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="#" class="px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 open-popup">+ Create New Template</a>
            </div>
                        ...
                        <div class="p-4 border rounded-lg hover:shadow mb-3">
                            <div class="flex justify-between items-center">
                                <div>
                                    ...
                                    <span class="inline-block mt-2 px-2 py-1 text-xs rounded {{ $booking->status === 'pending' ? 'bg-yellow-100 text-yellow-700' : 'bg-green-100 text-green-700' }}">
                                ...
                                <div class="flex gap-2">
                                    <form action="{{ route('vendor.booking.destroy', $booking->id) }}" method="POST" onsubmit="return confirm('Are you sure?');">
                                        @csrf @method('DELETE')
