                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="vendor"
                                ...
                                {{ old('vendor', $templates->vendor_id) == $Vendor->id ? 'selected' : '' }}>
                                {{ $Vendor->name }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="status" class="form-control select-user select-template-status @error('status') is-invalid @enderror">
                                <option value="{{ config('constants.status.active') }}"
                                    {{ old('status', $templates->status) == config('constants.status.active') ? 'selected' : '' }}>
                                    Active
                                </option>
                                <option value="{{ config('constants.status.inactive') }}"
                                    {{ old('status', $templates->status) == config('constants.status.inactive') ? 'selected' : '' }}>
                                    Inactive
                                </option>
                            </select>
                            @error('status')
