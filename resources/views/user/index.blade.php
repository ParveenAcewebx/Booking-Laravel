                            ...
                            <table id="user-list-table" class="table nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge {{ $user->status == config('constants.status.active') ? 'badge-light-success' : 'badge-light-danger' }}">
                                                {{ $user->status == config('constants.status.active') ? 'Active' : 'Inactive' }}
                                            </span>
                                        </td>
                                        <td>
